 ...
 *
 * @example TypedFunction<string, number>; // (input: string) => number
 *
 * @example TypedFunction<string[], number>; // (...inputs: string[]) => number
 *
 * @example TypedFunction<[string[]], number>; // (input: string[]) => number
 *
 * @example TypedFunction<[string, number], number>; // (input1: string, input2: number) => number
 *
 * @example TypedFunction<[string | undefined], number>; // (input1: string|undefined) => number
 */
